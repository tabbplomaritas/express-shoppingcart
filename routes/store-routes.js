...
storeRouter.post("/store", (req, res) => {
  pool.query("INSERT INTO shopping_cart (product, price, quantity, url) VALUES ($1::text, $2::money, $3::int, $4::text)", [req.body.product, req.body.price, 1, req.body.url]).then(() => {
